...
<template>
  <el-dialog v-model="dialog" title="修改密码" width="500px" @close="assign(form, {})" @open="formRef?.clearValidate()">
    <el-form ref="formRef" :model="form" :rules="rules" label-position="top" :disabled="loading" v-loading="loading">
      <el-form-item label="旧密码" prop="admin_password_old">
        <el-input type="password" show-password clearable v-model="form.admin_password_old"></el-input>
      </el-form-item>
      <el-form-item label="新密码" prop="admin_password_new">
        <el-input type="password" show-password clearable v-model="form.admin_password_new"></el-input>
      </el-form-item>
    </el-form>
    <template #footer>
